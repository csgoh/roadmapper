...
my_roadmap.timeline_start_date = "2022-12-01"
# my_roadmap.timeline_fill_colour = "#527a7a"
# my_roadmap.timeline_text_colour = "White"
my_roadmap.timeline_mode = Roadmap.WEEKLY
...
my_roadmap.add_milestone(group1, task2, "v1.1", "2023-01-24")
my_roadmap.add_milestone(group1, task2, "v1.2", "2023-04-15")

group2 = my_roadmap.add_group("Stream 2: Enable monitoring")
task3 = my_roadmap.add_task(group2, "Feature 3", "2022-04-24", "2023-01-24")
my_roadmap.add_milestone(group2, task3, "Monitoring Portal 1", "2023-01-24")
